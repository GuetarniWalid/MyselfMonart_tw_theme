...
> Décisions verrouillées de **la mission homepage**. Pilotage global multi-missions → [../../ROADMAP.md](../../ROADMAP.md) · Méthodo → [../../shared/METHODOLOGY.md](../../shared/METHODOLOGY.md) · Suivi GSC → [FOLLOWUP.md](FOLLOWUP.md).
