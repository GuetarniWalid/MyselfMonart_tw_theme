...
- `tableau-personnalise-famille` : **RÉSOLU 2026-06-06 — collection POSTER-ONLY** (confirmé par Walid : bascule poster, le « tableau »/« toile » = résidus d'avant). Mon éditorial de masse avait écrit à tort les specs canvas (toile 285g, cadre bois, encres archival) = **fausses allégations produit** pour des posters → **éditorial réécrit en version poster-exacte** (formats A4/A3/A2, cadre à poser, papier de qualité ; 0 mention toile/cadre bois/encres — vérifié live). seoTitle → « Poster Personnalisé Famille - Cadeau Déco sur Mesure ». H1 « Poster… » conservé (correct). ⚠️ Résidus restants hors périmètre éditorial : la `collection.description` (dormante, non affichée car masquée) + les **fiches produit** mentionnent encore « toile/aluminium/plexi » — nettoyage catalogue produit à prévoir séparément.
